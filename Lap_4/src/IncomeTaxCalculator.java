...
public class IncomeTaxCalculator {
	...
	public static void main(String[] args) {
		...
		System.out.print("Input Tax Income: ");
		...
		if(taxableIncome < 20000) { //[0-20000]
			...
			taxPayable = 20000 * TAX_RATE_ABOVE_20K +(taxableIncome - 400000) * TAX_RATE_ABOVE_40K;
		}
		else { //[60001-80000]
		...
		System.out.printf("The income tax payale is: %.2f", taxPayable);
